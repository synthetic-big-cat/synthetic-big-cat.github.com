        ...
        function (e, t, n) {
            ...
            var a = e('../common/PlayerInfo'), i = e('./MainGameUi'), r = e('../Common/PoolManager'), s = e('../Common/Utils'), l = e('./GameManager'), u = e('./AudioManager'), d = e('../common/DynamicLoad'), p = cc._decorator, f = p.ccclass, h = p.property, m = function (e) {
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        o.parent = this.fruitNode, o.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], o.children[0].getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], o.getComponent('fruitData').fruitNumber = e, o.position = t, o.scale = 0, o.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -100), o.getComponent(cc.PhysicsCircleCollider).radius = o.height / 2, o.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(o).to(0.5, { scale: 1 }, { easing: 'backOut' }).call(function () {
