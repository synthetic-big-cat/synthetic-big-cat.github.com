window.__require = function e(t, n, o) {
    ...
    AddScore: [
        function (e, t, n) {
            ...
            var a = e('../Common/Utils'), i = cc._decorator, r = i.ccclass, s = i.property, l = function (e) {
                    function t() {
    ...
    AdjusWithHeight: [
        function (e, t, n) {
            ...
            var a = cc.Enum({
                    TOP: 0,
                    BOTTOM: 1
                }), i = cc._decorator, r = i.ccclass, s = i.property, l = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
        ...
        function (e, t, n) {
            ...
            var o = {
                doLabStrAni: function (e, t, n) {
                    ...
                    var o = t.split(''), c = 0, a = n / o.length;
                ...
                gunNumLabAni: function (e, t) {
                    ...
                    if (t != n) {
                        var o = 0, c = t - n >= 50 ? 50 : t - n;
                        e.node.runAction(cc.sequence(cc.callFunc(function () {
                            o >= c - 1 ? e.string = t : (n++, e.string = n), o++;
                        }), cc.delayTime(0.02)).repeat(c));
                    }
                },
                ...
                fireworksAni: function (e, t, n, o) {
                    for (var c = 0; c < t; c++) {
                        ...
                        a.scale = 0.3 + 0.5 * Math.random(), a.position = n, a.color = cc.color(this.fireColorArr[this.returnRanNum(0, this.fireColorArr.length - 1)]), e.addChild(a, 88);
                        var i = this.returnRanNum(o - 15, o + 15), r = this.returnRanNum(300, 1000);
                        this.fireObjAni(a, i, r, 350, 0.005 * c);
                    }
                },
                fireObjAni: function (e, t, n, o) {
                    var c = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, a = 0.1 + 0.5 * Math.random();
                    e.runAction(cc.rotateBy(a, this.returnRanNum(-360, 360)).repeatForever());
                    var i = cc.misc.degreesToRadians(t), r = cc.v2(Math.cos(i) * n, Math.sin(i) * n), s = n / o;
                ...
                bombObjAni: function (e, t, n, o, c, a) {
                    ...
                    var i = cc.misc.degreesToRadians(t), r = cc.v2(Math.cos(i) * n, Math.sin(i) * n), s = n / o, l = c ? 0 : e.scale, u = a ? 0 : 255;
                    e.runAction(cc.sequence(cc.spawn(cc.scaleTo(s + 0.1, l), cc.moveBy(s, r).easing(cc.easeQuadraticActionOut()), cc.fadeTo(s + 0.1, u)), cc.fadeOut(0.1), cc.removeSelf(!0)));
                },
    ...
    AudioManager: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = cc._decorator, i = a.ccclass, r = a.property, s = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    }, t.Instance = null, c([r({ type: cc.AudioClip })], t.prototype, 'audioClip', void 0), t = n = c([i], t);
                }(cc.Component);
    ...
    AutoDestroy: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../Common/PoolManager'), i = cc._decorator, r = i.ccclass, s = i.property, l = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
    ...
    DataManager: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = cc._decorator, i = a.ccclass, r = a.property, s = function () {
                    return function () {
    ...
    DynamicLoad: [
        function (e, t, n) {
            ...
            var a = cc._decorator, i = a.ccclass, r = a.property, s = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.caidia = [], t.fllows = [], t.fruit = [], t.guozhiZ = [], t.guozhiL = [], t.fruitL = [], t.TGColors = [], t;
                    }
                    var n;
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        null != n.Instance && n.Instance.destroy(), n.Instance = this;
                    ...
                    }, t.Instance = null, c([r(cc.SpriteFrame)], t.prototype, 'caidia', void 0), c([r(cc.SpriteFrame)], t.prototype, 'fllows', void 0), c([r(cc.SpriteFrame)], t.prototype, 'fruit', void 0), c([r(cc.SpriteFrame)], t.prototype, 'guozhiZ', void 0), c([r(cc.SpriteFrame)], t.prototype, 'guozhiL', void 0), c([r(cc.SpriteFrame)], t.prototype, 'fruitL', void 0), t = n = c([i], t);
                }(cc.Component);
            n.default = s, cc._RF.pop();
        },
        {}
    ...
    EffectCenter: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../Common/Utils'), i = e('../Common/PoolManager'), r = e('../Common/SpriteManager'), s = e('../common/DynamicLoad'), l = e('./AudioManager'), u = cc._decorator, d = u.ccclass, p = u.property, f = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        t.position = e, t.scale = 0.2, t.runAction(cc.sequence(cc.scaleTo(0.3, 1.2), cc.fadeOut(0.3))), t.children[0].runAction(cc.spawn(cc.moveBy(0.5, -65, 65), cc.fadeOut(0.6))), t.children[1].runAction(cc.spawn(cc.moveBy(0.5, 65, -65), cc.fadeOut(0.6))), t.children[2].runAction(cc.spawn(cc.moveBy(0.5, -65, -65), cc.fadeOut(0.6))), t.children[3].runAction(cc.spawn(cc.moveBy(0.5, 65, 65), cc.fadeOut(0.6)));
                    }, t.prototype.MilkEffect = function (e, t) {
                        var n = i.default.Spawn('milk', this.downEffectPartiParent);
                        n.color = new cc.Color().fromHEX(s.default.Instance.TGColors[t % 10]), n.position = e, n.scale = 0.3, n.runAction(cc.sequence(cc.scaleTo(0.3, 1), cc.fadeOut(0.3)));
                    }, t.prototype.FireLight = function () {
                        this.fireLightNode.stopAllActions(), this.fireLightNode.opacity = 0, this.fireLightNode.runAction(cc.sequence(cc.fadeTo(0.11, 180).easing(cc.easeCubicActionIn()), cc.fadeTo(0.18, 0)));
                        ...
                        for (var c = a.default.ConvertPosition(t, this.uiEffectParent), r = a.default.ConvertPosition(n, this.uiEffectParent).sub(cc.v2(0, 0)), s = 0; s < o; s++) {
                            ...
                            l.parent = this.uiEffectParent, l.position = c, l.scale = 0.7;
                            var u = c.add(cc.v2(a.default.Random(-60, 60), a.default.Random(-60, 60))), d = cc.jumpTo(0.3, u, a.default.Random(30, 150), 1), p = cc.sequence(d, cc.moveBy(0.06, cc.v2(0, 10)), cc.moveBy(0.06, cc.v2(0, -10))), f = r.sub(c), h = (cc.v2(u), cc.v2(a.default.Random(-300, 300), f.y * a.default.Random(0.2, 0.8)), cc.v2(r)), m = cc.moveTo(0.3, h).easing(cc.easeBackIn());
                            l.runAction(cc.sequence(p, cc.delayTime(0.05), m, cc.callFunc(function (e) {
                        ...
                        for (var n = Math.floor(a.default.Random(5, 8)), o = a.default.ConvertPosition(e, this.uiEffectParent), c = a.default.ConvertPosition(t, this.uiEffectParent).sub(cc.v2(0, 0)), r = 0; r < n; r++) {
                            ...
                            var l = 0.07 * r;
                            s.runAction(cc.sequence(cc.delayTime(l), cc.moveTo(0.7, c), cc.callFunc(function (e) {
                        ...
                        n.parent = this.upEffectPartiParent, n.getComponent('AddScore').SetScore(e), n.position = t, n.runAction(cc.fadeIn(0.2)), n.runAction(cc.sequence(cc.moveBy(0.5, cc.v2(0, 40)), cc.delayTime(0.7), cc.fadeOut(0.3), cc.callFunc(function () {
                        ...
                        for (var o = a.default.RandomInteger(t, n), c = 0; c < o; c++) {
                            ...
                            r.parent = this.downEffectPartiParent, r.position = e, r.scale = a.default.Random(0.4, 0.8);
                            var s = e.add(cc.v2(a.default.Random(-64, 64), a.default.Random(-30, -90))), l = a.default.Random(0.5, 0.55), u = a.default.Random(20, 90);
                            r.runAction(cc.sequence(cc.jumpTo(l, s, u, 1), cc.delayTime(1), cc.callFunc(function (e) {
                                e.stopAllActions(), e.destroy();
                            }, this))), r.runAction(cc.sequence(cc.delayTime(0.5 * l), cc.fadeOut(0.5 * l)));
                        }
                        ...
                        for (var n = a.default.RandomInteger(3, 6), o = 0; o < n; o++) {
                            ...
                            c.node.scale = a.default.Random(0.2 * s, 0.6 * s), c.node.opacity = a.default.Random(150, 180);
                            var l = cc.v2(a.default.Random(-10, 10), a.default.Random(-10, 10));
                            c.node.runAction(cc.sequence(cc.delayTime(0.2), cc.fadeOut(0.3))), c.node.runAction(cc.sequence(cc.moveBy(0.5, l), cc.callFunc(function (e) {
                        ...
                        for (var t = a.default.RandomInteger(10, 15), n = 0; n < t; n++) {
                            ...
                            32, o.SetSprite(c, cc.v2(32, 32)), o.node.scale = a.default.Random(0.5, 1.5);
                            var s = cc.v2(0, 1);
                            ...
                            o.node.runAction(cc.sequence(cc.delayTime(0.2 * u), cc.scaleTo(0.8 * u, a.default.Random(0.1, 0.3)))), o.node.runAction(cc.sequence(cc.moveBy(u, s.mul(l)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        }
                        var d = i.default.Spawn('EffectSprite').getComponent('EffectSprite');
                        d.node.parent = this.downEffectPartiParent, d.Reset(), d.node.position = e, d.SetSprite(r.default.Instance.GetSpriteFrame('whiteCircle'), cc.v2(150, 150)), d.node.opacity = 200, d.node.scale = 0, d.node.runAction(cc.scaleTo(0.32, 1)), d.node.runAction(cc.sequence(cc.delayTime(0.2), cc.fadeOut(0.1), cc.callFunc(function (e) {
                            i.default.Despawn('EffectSprite', e);
                        }, this)));
                        ...
                        for (var t = a.default.RandomInteger(20, 26), n = 0; n < t; n++) {
                            ...
                            Math.floor(20 * a.default.Random(0.3, 1.6));
                            32, o.SetSprite(c, cc.v2(32, 32)), o.node.scale = a.default.Random(0.3, 1.6);
                            var s = cc.v2(0, 1);
                            s.rotateSelf(a.default.AngleToRadian(360 * Math.random()));
                            var l = a.default.Random(80, 120);
                            o.node.position.add(s.mul(a.default.Random(0, 30)));
                            var u = a.default.Random(0.3, 0.36);
                            o.node.runAction(cc.sequence(cc.delayTime(u * a.default.Random(0.1, 0.3)), cc.scaleTo(0.8 * u, a.default.Random(0.1, 0.3)))), o.node.runAction(cc.sequence(cc.moveBy(u, s.mul(l)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        }
                        ...
                        for (var n = a.default.RandomInteger(15, 20), o = 0; o < n; o++) {
                            ...
                            s.SetSprite(l, cc.v2(18, 18)), c.setPosition(e.x + 80 * Math.random() - 40, e.y + 80 * Math.random() - 40), c.setScale(0.5 * Math.random() + 0.5), c.opacity = 150 * Math.random() + 50, c.color = t;
                            var u = 360 * Math.random() * Math.PI / 180, d = 46 + 46 * Math.random(), p = cc.v2(e.x + Math.sin(u) * d, e.y + Math.cos(u) * d);
                            c.runAction(cc.sequence(cc.spawn(cc.moveTo(0.8, p).easing(cc.easeCircleActionOut()), cc.scaleTo(0.8 * a.default.Random(0.5, 1), 0).easing(cc.easeCircleActionIn())), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        }
                        ...
                        for (var n = a.default.RandomInteger(27, 36), o = 0; o < n; o++) {
                            ...
                            s.SetSprite(l, cc.v2(32, 32)), c.setPosition(e.x + 90 * Math.random() - 45, e.y + 90 * Math.random() - 45), c.setScale(0.55 * Math.random() + 0.7), c.opacity = 160 * Math.random() + 70;
                            var u = 360 * Math.random() * Math.PI / 180, d = 60 + 80 * Math.random(), p = cc.v2(e.x + Math.sin(u) * d, e.y + Math.cos(u) * d);
                            c.runAction(cc.sequence(cc.spawn(cc.moveTo(0.8, p).easing(cc.easeCircleActionOut()), cc.scaleTo(0.8 * a.default.Random(0.5, 1), 0).easing(cc.easeCircleActionIn())), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        }
                        ...
                        for (var t = a.default.RandomInteger(12, 15), n = 0; n < t; n++) {
                            var o = i.default.Spawn('EffectSprite').getComponent('EffectSprite');
                            o.node.parent = this.downEffectPartiParent, o.Reset(), o.SetSprite(r.default.Instance.GetSpriteFrame('ball'), cc.v2(48, 48)), o.node.scale = a.default.Random(0.6, 1), o.node.opacity = a.default.RandomInteger(120, 250), o.node.position = e.add(cc.v2(a.default.Random(-25, 25)));
                            var c = cc.v2(0, a.default.Random(30, 80)).rotate(a.default.AngleToRadian(a.default.Random(0, 360))), s = cc.moveBy(0.7, c), l = cc.scaleTo(0.6, 0), u = cc.fadeOut(0.5);
                            o.node.runAction(cc.spawn(s, l)), o.node.runAction(cc.sequence(cc.delayTime(0.2), u, cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        }
                        ...
                        for (var t = 0; t < e.length; t++) {
                            ...
                            for (var o = 0; o < 40; o++) {
                                ...
                                c.position = cc.v2(e[t][0], e[t][1]), c.scale = a.default.Random(0.7, 1), c.getComponent(cc.Sprite).spriteFrame = s.default.Instance.caidia[a.default.RandomInteger(0, 6)];
                                var r = c.position, u = r.x + a.default.Random(0.5 * -cc.winSize.width, 0.05 * -cc.winSize.width) * n, d = r.y + a.default.Random(100, 500), p = cc.v2(r.x + 0.8 * (u - r.x), r.y + 0.5 * (d - r.y) + 200);
                                c.runAction(cc.sequence(cc.spawn(cc.bezierTo(1, [
                                    r,
                                    p,
                                    cc.v2(u, d)
                                ]).easing(cc.easeCircleActionOut()), cc.moveBy(2.8, 0, 1.2 * -cc.winSize.height * a.default.Random(0.8, 1.2)).easing(cc.easeCubicActionIn()), cc.moveBy(2.8, a.default.Random(0, -300) * n, 0), cc.rotateBy(2, a.default.Random(360, 720) * (2 * Math.round(Math.random()) - 1)), cc.sequence(cc.moveBy(2 * (0.1 * Math.random() + 0.3), (25 * Math.random() + 25) * (2 * Math.round(Math.random()) - 1), 0), cc.moveBy(2 * (0.1 * Math.random() + 0.3), (25 * Math.random() + 25) * (2 * Math.round(Math.random()) - 1), 0), cc.moveBy(2 * (0.1 * Math.random() + 0.3), (25 * Math.random() + 25) * (2 * Math.round(Math.random()) - 1), 0))), cc.callFunc(function (e, t) {
                        ...
                        for (var t = a.default.RandomInteger(20, 26), n = 0; n < t; n++) {
                            ...
                            Math.floor(20 * a.default.Random(0.3, 1.6));
                            28, o.SetSprite(c, cc.v2(28, 28)), o.node.scale = a.default.Random(0.3, 1.6);
                            var s = cc.v2(0, 1);
                            s.rotateSelf(a.default.AngleToRadian(360 * Math.random()));
                            var l = a.default.Random(80, 120);
                            o.node.position.add(s.mul(a.default.Random(0, 30)));
                        ...
                        for (var t = function (t) {
                                    ...
                                    o.node.runAction(cc.sequence(cc.moveBy(0.45, c), cc.callFunc(function () {
                                        i.default.Despawn('lightEffect', o.node);
                                    }, n))), o.node.runAction(cc.rotateBy(0.45, 360)), o.node.runAction(cc.sequence(cc.delayTime(0.225), cc.scaleTo(0.225, 0.4)));
                                }, n = this, o = 0; o < 12; o++)
                            t(o);
                        ...
                        for (var t = a.default.RandomInteger(100, 101), n = 0; n < t; n++) {
                            ...
                            80, o.SetSprite(c, cc.v2(80, 80)), o.node.scale = a.default.Random(0.6, 1.3), o.node.angle = a.default.Random(0, 360);
                            var s = cc.v2(0, 1);
                            s.rotateSelf(a.default.AngleToRadian(360 * Math.random()));
                            var l = a.default.Random(20, 280);
                            o.node.position.add(s.mul(a.default.Random(0, 30)));
                            var u = a.default.Random(1, 1.3), d = a.default.Random(0.01, 0.012) * n;
                            o.node.runAction(cc.sequence(cc.delayTime(d), cc.delayTime(0.6 * u), cc.fadeOut(0.4 * u))), o.node.opacity = 0, o.node.runAction(cc.sequence(cc.delayTime(d), cc.fadeTo(0.1, a.default.Random(120, 240)))), o.node.runAction(cc.sequence(cc.delayTime(d), cc.moveBy(u, s.mul(l)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        ...
                        for (var n = 0; n < 6; n++) {
                            ...
                            o.parent = this.downEffectPartiParent, o.position = e.add(cc.v2(a.default.Random(-50, 50), 0)), o.scale = a.default.Random(0.3, 1), o.color = t;
                            var c = cc.v2(0, 1);
                            c = c.rotate(a.default.AngleToRadian(a.default.Random(-60, 60)));
                            var r = a.default.Random(60, 100), s = cc.moveBy(0.3, c.mul(r));
                            o.runAction(s), o.runAction(cc.sequence(cc.delayTime(0.05), cc.scaleTo(0.25, a.default.Random(0.1, 0.2)))), o.runAction(cc.sequence(cc.delayTime(0.2), cc.fadeOut(0.1)));
                        }
                        ...
                        for (var t = 0; t < 3; t++) {
                            ...
                            o.Reset(), n.position = e, n.scale = 0, o.SetSprite(r.default.Instance.GetSpriteFrame('ball'), cc.v2(20, 20)), o.node.color = new cc.Color().fromHEX('#AD0909'), n.setContentSize(a.default.RandomInteger(16, 18), a.default.RandomInteger(16, 18)), n.runAction(cc.sequence(cc.delayTime(0.5 * t), cc.delayTime(0.5), cc.scaleTo(0.1, 0))), n.runAction(cc.sequence(cc.delayTime(0.4 * t), cc.scaleTo(0.3, 1), cc.moveBy(0.6, cc.v2(0, -180)), cc.callFunc(function () {
                            }, n)));
                        }
                        ...
                        for (var n = a.default.RandomInteger(32, 43), o = 0; o < n; o++) {
                            ...
                            c.parent = this.downEffectPartiParent, c.position = e, c.opacity = 0, c.setContentSize(120, 120), c.scale = a.default.Random(0.3, 1.3);
                            var r = cc.v2(0, 1);
                            ...
                            var l = a.default.Random(0.9, 1.2), u = a.default.Random(0.05, 0.15);
                            c.runAction(cc.sequence(cc.delayTime(u), cc.delayTime(l * a.default.Random(0.1, 0.3)), cc.scaleTo(0.8 * l, a.default.Random(0.2, 0.3)))), c.opacity = 0, c.runAction(cc.sequence(cc.delayTime(u), cc.fadeTo(0.08, a.default.Random(160, 240)))), c.runAction(cc.sequence(cc.delayTime(u), cc.moveBy(l, r.mul(s)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
                                e.stopAllActions(), e.destroy();
                            }, this)));
                        ...
                        for (var t = a.default.RandomInteger(6, 7), n = 0; n < t; n++) {
                            ...
                            var s = a.default.Random(0.4, 1), l = a.default.Random(1, 1.2), u = a.default.Random(0.07, 0.09) * n;
                            o.node.runAction(cc.sequence(cc.delayTime(0.75 * l), cc.fadeOut(0.25 * l), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this))), o.node.runAction(cc.sequence(cc.delayTime(u), cc.spawn(cc.fadeIn(0.15), cc.scaleTo(0.15, s), cc.moveBy(l, cc.v2(0, 90 * l)))));
                        }
                    }, t.prototype.WinkJump = function (e) {
                        for (var t = a.default.RandomInteger(16, 17), n = 0; n < t; n++) {
                            var o = i.default.Spawn('EffectSprite').getComponent('EffectSprite');
                            o.node.parent = this.upEffectPartiParent, o.Reset(), o.SetSprite(r.default.Instance.GetSpriteFrame('wink'), cc.v2(110, 110)), o.node.scale = a.default.Random(0.3, 1.2), o.node.opacity = a.default.RandomInteger(170, 250), o.node.position = e.add(cc.v2(a.default.Random(-30, 30), a.default.Random(-30, 30)));
                            var c = cc.v2(a.default.Random(-150, 150), a.default.Random(20, -60));
                            c = cc.v2(o.node.position.add(c));
                            var s = a.default.Random(1, 1.2), l = cc.jumpTo(s, c, a.default.Random(120, 120), 1), u = a.default.Random(0, 100) < 50 ? 1 : -1, d = cc.rotateBy(s, a.default.Random(200, 300) * u), p = cc.fadeOut(0.2 * s);
                            o.node.runAction(cc.spawn(l, d)), o.node.runAction(cc.sequence(cc.delayTime(0.8 * s), p, cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        }
                        ...
                        for (var n = a.default.RandomInteger(20, 23), o = 0; o < n; o++) {
                            ...
                            64, c.SetSprite(s, cc.v2(64, 64)), c.node.scale = a.default.Random(0.3, 1.6);
                            var l = cc.v2(0, 1);
                            ...
                            var d = a.default.Random(0.9, 1.2), p = a.default.Random(0.05, 0.3);
                            p = a.default.Random(0.005, 0.015) * o, c.node.runAction(cc.sequence(cc.delayTime(p), cc.delayTime(d * a.default.Random(0.1, 0.3)), cc.scaleTo(0.8 * d, a.default.Random(0.2, 0.3)))), c.node.opacity = 0, c.node.runAction(cc.sequence(cc.delayTime(p), cc.fadeTo(0.08, a.default.Random(160, 240)))), c.node.runAction(cc.sequence(cc.delayTime(p), cc.moveBy(d, l.mul(u)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
                                i.default.Despawn('EffectSprite', e);
                            }, this)));
                        ...
                        for (var n = t, o = [
                            ...
                            for (var s = 0; s < n; s++) {
                                ...
                                l.parent = this.upEffectPartiParent, l.stopAllActions(), l.opacity = 255, l.scale = a.default.Random(0.5, 1);
                                var u = o[c];
                                l.setPosition(u);
                                var d = cc.v2(a.default.RandomInteger(0, 80) * r, a.default.RandomInteger(0, 50)), p = a.default.RandomInteger(180, 360) * r, f = a.default.RandomInteger(20, 40);
                        ...
                        for (var n = t, o = [
                            ...
                            for (var s = 0; s < n; s++) {
                                ...
                                l.parent = this.upEffectPartiParent, l.stopAllActions(), l.opacity = 255, l.scale = a.default.Random(0.2, 0.5);
                                var u = o[c];
                                l.setPosition(u);
                                var d = cc.v2(a.default.RandomInteger(0, 80) * r, a.default.RandomInteger(0, 50)), p = a.default.RandomInteger(180, 360) * r, f = a.default.RandomInteger(20, 40);
                        ...
                        for (var t = [
                            ...
                            for (var c = 0; c < 15; c++) {
                                ...
                                l.Reset();
                                var u = cc.v2(18, 18);
                                l.SetSprite(r.default.Instance.GetSpriteFrame('ball'), u), s.color = cc.color(120, 120, 120), s.stopAllActions(), s.opacity = 255, s.scale = a.default.Random(0.6, 1);
                                var d = t[n];
                                s.setPosition(d);
                                var p = cc.v2(a.default.RandomInteger(-5, 54) * o, a.default.RandomInteger(-20, 20)), f = a.default.RandomInteger(180, 360) * o, h = a.default.RandomInteger(15, 45);
    ...
    EffectSprite: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('./PoolManager'), i = cc._decorator, r = i.ccclass, s = i.property, l = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), t.prototype.onLoad = function () {
                        ...
                        this.startWork = !1, this.stateCheck = !1, this.node.anchorX = 0.5, this.node.anchorY = 0.5, this.node.opacity = 255, this.node.angle = 0, this.node.scale = 1, this.node.color = cc.Color.WHITE, this.node.getComponent(cc.Sprite).sizeMode = cc.Sprite.SizeMode.TRIMMED, this.node.stopAllActions(), this.unscheduleAllCallbacks();
                        ...
                        var e = this.camera.x + cc.winSize.width / 2, t = this.camera.x - cc.winSize.width / 2, n = this.camera.y + cc.winSize.height / 2, o = this.camera.y - cc.winSize.height / 2;
    ...
    FailedUi: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('./GameManager'), i = e('../Common/Utils'), r = e('./MainGameUi'), s = e('../common/PlayerInfo'), l = cc._decorator, u = l.ccclass, d = l.property, p = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.clickMask = null, t.failedUiBox = null, t.di = null, t.levelTxt = null, t.guan = null, t.continueTip = null, t.scoreLabel = null, t.highScoreNode = null, t.highScore = null, t.highScoreLabel = null, t.resultTxt = null, t.overTxt = null, t.moreGameBtn = null, t.reStartBtn = null, t.failedBoxPos = cc.v2(0, -500), t.standardScore = 0, t.canClick = !1, t.bgMask = null, t.bencichengji = null, t.bencichengjiarr = [], t.gengduoyouxi = null, t.gengduoyouxiarr = [], t;
                    }
                    var n;
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        1 != e && (this.bencichengji.getComponent(cc.Sprite).spriteFrame = this.bencichengjiarr[e - 1], this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame = this.gengduoyouxiarr[e - 1]), this.continueTip.getComponent(cc.Label).string = 1 == e ? '点击继续' : 2 == e ? '點擊繼續' : 4 == e ? '클릭 하여 계속' : 'Click Continue', this.reStartBtn.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(0.5, 1.1), cc.scaleTo(0.55, 1), cc.delayTime(0.5)))), cc.tween(this.moreGameBtn).to(0.5, { scale: 1.1 }).to(0.5, { scale: 1 }).union().repeatForever().start();
                    }, t.prototype.update = function (e) {
                    }, t.prototype.bannerButtonFunc = function () {
                    }, t.prototype.ShowFailedUi = function (e, t) {
                        var n = this;
                        this.scheduleOnce(function () {
                            r.default.Instance.HideScorePanel(), n.levelTxt.string = r.default.Instance.level.toString(), n.scoreLabel.string = s.default.score.toString(), n.highScoreLabel.string = t, n.resultTxt.string = n.GetContentByScore(e), n.overTxt.string = '当前关卡已完成' + Math.floor(r.default.Instance.nowYQ / r.default.Instance.passlevelYQ * 100) + '%', n.canClick = !1, n.levelTxt.string = e, n.bgMask.runAction(cc.fadeTo(0.36, 150)), n.scheduleOnce(function () {
                                i.default.CenteredUi(10, this.di, this.levelTxt.node, this.guan), this.failedUiBox.y = cc.winSize.height / 2 + this.failedUiBox.height / 2, this.failedUiBox.runAction(cc.sequence(cc.moveTo(0.36, this.failedBoxPos).easing(cc.easeBackOut()), cc.callFunc(function () {
                                    this.clickMask.on(cc.Node.EventType.TOUCH_START, this.OnClickCloseMask, this), this.moreGameBtn.on(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.continueTip.opacity = 0, this.continueTip.runAction(cc.repeatForever(cc.sequence(cc.fadeIn(0.5), cc.delayTime(0.5), cc.fadeOut(0.5)))), this.canClick = !0;
                                }, this)));
                            }, 0);
                        }, 0.5);
    ...
    GameFunction: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../common/PlayerInfo'), i = e('./MainGameUi'), r = e('../Common/PoolManager'), s = e('../Common/Utils'), l = e('./GameManager'), u = e('./AudioManager'), d = e('../common/DynamicLoad'), p = cc._decorator, f = p.ccclass, h = p.property, m = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        a.default.playNum, a.default.bgNumber >= 3 && (a.default.bgNumber = 0), a.default.bgNumber++, a.default.playNum++, cc.tween(this.lineNode.children[0]).to(0.3, { opacity: 255 }).to(0.3, { opacity: 0 }).union().repeatForever().start(), this.lineNode.children[0].active = !1, this.fruitS = [
                            'PuTaoS',
                            'YingTaoS',
                            'JuZiS',
                            'NingMengS',
                        ...
                        if (this.lineNode.children[0].y - n.Instance.fruitHeigth < -20 && 0 == this.endOne) {
                            for (var t = 0; t < this.fruitNode.children.length; t++)
                                this.fruitNode.children[t].removeComponent(cc.PhysicsCircleCollider), this.fruitNode.children[t].removeComponent(cc.RigidBody);
                        ...
                        n.parent = this.lineNode, n.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[9 - e], n.children[0].getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[9 - e], n.getComponent('fruitData').fruitNumber = e, n.position = this.lineNode.children[1].position, n.scale = 0, n.getComponent(cc.RigidBody).type = cc.RigidBodyType.Static, n.getComponent(cc.PhysicsCircleCollider).radius = 0, n.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(n).to(0.5, { scale: 1 }, { easing: 'backOut' }).call(function () {
                            t.targetFruit = n;
                        }).start();
                    }, t.prototype.createLevelUpFruit = function (e, t) {
                        var o = cc.instantiate(this.fruitPre);
                        o.parent = this.fruitNode, o.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[9 - e], o.children[0].getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[9 - e], o.getComponent('fruitData').fruitNumber = e, o.position = t, o.scale = 0, o.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -100), o.getComponent(cc.PhysicsCircleCollider).radius = o.height / 2, o.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(o).to(0.5, { scale: 1 }, { easing: 'backOut' }).call(function () {
                        ...
                        u.default.Instance.Play(3, !1, 0.5), u.default.Instance.Play(6, !1, 0.3);
                        for (var o = 0; o < 10; o++) {
                            var c = r.default.Spawn('juicePre', this.downEffect);
                            c.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruitL[e];
                            var a = 359 * Math.random(), i = 30 * Math.random() + n / 2, l = cc.v2(Math.sin(a * Math.PI / 180) * i, Math.cos(a * Math.PI / 180) * i);
                            c.scale = 0.5 * Math.random() + n / 100;
                            var p = 0.5 * Math.random();
                            c.position = t, c.runAction(cc.sequence(cc.spawn(cc.moveBy(p, l), cc.scaleTo(p + 0.5, 0.3), cc.rotateBy(p + 0.5, s.default.RandomInteger(-360, 360))), cc.fadeOut(0.1), cc.callFunc(function () {
                                h.active = !1;
                            }, this)));
                        }
                        for (var f = 0; f < 20; f++) {
                            ...
                            p = 0.5 * Math.random();
                            h.position = t, h.runAction(cc.sequence(cc.spawn(cc.moveBy(p, l), cc.scaleTo(p + 0.5, 0.3)), cc.fadeOut(0.1), cc.callFunc(function () {
                                h.active = !1;
                            }, this)));
                        }
                        var m = r.default.Spawn('juicePre', this.downEffect);
                        m.getComponent(cc.Sprite).spriteFrame = d.default.Instance.guozhiZ[e], m.position = t, m.scale = 0, m.angle = s.default.RandomInteger(0, 360), m.runAction(cc.sequence(cc.spawn(cc.scaleTo(0.2, n / 150), cc.fadeOut(1)), cc.callFunc(function () {
                            m.active = !1;
                        })));
                        ...
                        for (var e = 0; e < 25; e++) {
                            ...
                            var n = 360 * Math.random() * Math.PI / 180, o = 20 * Math.random(), c = 35 + 60 * Math.random(), a = cc.v2(Math.sin(n) * (o + c), Math.cos(n) * (o + c));
                            cc.tween(t).to(0.8, {
                                position: a,
                                angle: s.default.getRandomNum(180, 360, !0),
                                opacity: s.default.getRandomNum(0.4, 0.8)
                            }, { easing: 'cubicOut' }).then(cc.removeSelf(!0));
                        }
                    }, t.prototype.conboHit = function (e) {
                        var t = this;
                        u.default.Instance.Play(5, !1, 0.5);
                        var n = r.default.Spawn('addScore', this.bazieffect);
                        n.position = cc.v2(0, -200), n.scale = 0.2, n.children[0].getComponent(cc.Label).string = e, n.runAction(cc.sequence(cc.spawn(cc.scaleTo(0.3, 1), cc.moveBy(0.3, 0, 200), cc.rotateBy(0.3, 720), cc.callFunc(function () {
                            t.getScore(10 * e, cc.v2(0, -200), 0.8, 0.5);
                        })), cc.fadeOut(0.5))), this.levelUpEffect();
                    }, t.prototype.getScore = function (e, t, n, o) {
                        var c = r.default.Spawn('score', this.bazieffect);
                        c.position = t, c.scale = 0.2, c.children[1].getComponent(cc.Label).string = e, c.runAction(cc.sequence(cc.spawn(cc.scaleTo(0.3, n), cc.moveBy(0.3, 0, 150), cc.rotateBy(0.3, 720)), cc.fadeOut(o)));
                        ...
                        for (var t = s.default.getRandomNum(80, 100), n = 0; n < t; n++) {
                            ...
                            var c = 360 * Math.random() * Math.PI / 180, a = 360 * Math.random(), i = cc.v2(o.x + Math.sin(c) * a, o.y + Math.cos(c) * a + 150);
                            cc.v2(i.x, i.y + 100);
                            o.runAction(cc.sequence(cc.spawn(cc.moveTo(0.255, i).easing(cc.easeCubicActionOut()), cc.scaleTo(0.255, 1 * Math.random() + 0.5), cc.moveBy(4.25, cc.v2(0, 0.8 * -cc.winSize.height - Math.random() * cc.winSize.height)), cc.rotateBy(4.25, (1800 * Math.random() + 1200) * (Math.random() > 0.5 ? 1 : -1)), cc.sequence(cc.moveBy(0.17 * (8 * Math.random() + 6), cc.v2((100 * Math.random() + 100) * (Math.random() > 0.5 ? -1 : 1), 0)), cc.moveBy(0.17 * (8 * Math.random() + 6), cc.v2((100 * Math.random() + 100) * (Math.random() > 0.5 ? -1 : 1), 0)), cc.moveBy(0.17 * (8 * Math.random() + 6), cc.v2((100 * Math.random() + 100) * (Math.random() > 0.5 ? -1 : 1), 0))), cc.sequence(cc.delayTime(0.17 * s.default.getRandomNum(20, 24.5)), cc.fadeOut(0.17))), cc.removeSelf(!0)));
                        }
                    }, t.prototype.ShowLandParti = function (e, t) {
                        for (var n = t, o = [
                            ...
                            for (var i = function () {
                                        ...
                                        t.setSiblingIndex(4), t.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fllows[s.default.getRandomNum(0, 5, !0)], t.stopAllActions(), t.opacity = 255, t.scale = 0.3;
                                        var n = o[c];
                                        t.setPosition(n);
                                        var i = cc.v2(s.default.getRandomNum(0, 400, !0) * a, -s.default.getRandomNum(300, 500, !0)), u = s.default.getRandomNum(1440, 3600, !0) * a, p = s.default.getRandomNum(450, 600, !0);
                                        t.runAction(cc.sequence(cc.spawn(cc.sequence(cc.jumpBy(s.default.RandomInteger(1500, 1700) / p, i, p, 1), cc.spawn(cc.moveBy(50 / p, cc.v2(0, -30)), cc.fadeOut(50 / p))), cc.scaleTo(s.default.RandomInteger(1500, 1700) / p, s.default.getRandomNum(0.4, 0.7, !1)), cc.rotateTo(s.default.RandomInteger(1500, 1700) / p, u / 2)), cc.callFunc(function () {
    ...
    GameManager: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('./FailedUi'), i = e('./MainGameUi'), r = e('./DataManager'), s = e('../common/PlayerInfo'), l = cc._decorator, u = l.ccclass, d = (l.property, function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        var e = cc.find('Canvas').getComponent('MainGameJS'), t = r.default.Instance.GetPlayerHighScore();
            ...
            var o = {
                ...
                setButtonClickEvents: function (e, t, n, o, c) {
                    ...
                    for (var i = 0; i < a.length; i++) {
                        ...
                        s.clickEvents.push(r), (void 0 == c || c) && (s.transition = cc.Button.Transition.SCALE, s.duration = 0.1, s.zoomScale = 1.2);
                    }
                },
    ...
    InputController: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('./GameFunction'), i = e('../common/PlayerInfo'), r = e('../Common/PoolManager'), s = e('../Common/Utils'), l = cc._decorator, u = l.ccclass, d = l.property, p = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.Rocker = null, t.stick = null, t.Max_r = 100, t.RockerJS = null, t.speed = 400, t.Arrow = null, t.knife = null, t.startPoint = null, t.touchPoint = null, t.endPoint = null, t.ddir = cc.v2(0, 0), t.isCut = !1, t.comboTime = 0, t.comboInterval = 0.4, t.comboNumber = 0, t.comboMaxNum = 7, t.touchNum = 0, t.createFruitCount = 0, t.istest = !1, t;
                    }
                    var n;
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        null != n.Instance && n.Instance.destroy(), n.Instance = this;
                        ...
                        if (i.default.playerTouch && null != a.default.Instance.targetFruit) {
                            this.touchNum = 1;
                            var t = this.node.convertToNodeSpaceAR(e.getLocation()).x, n = a.default.Instance.targetFruit.y;
                            cc.tween(a.default.Instance.targetFruit).to(0.1, { position: cc.v2(t, n) }).start();
                        }
                        ...
                        e.position = cc.v2(0, 200), e.scale = 0, e.opacity = 255, e.children[1].getComponent(cc.Label).string = this.comboNumber.toString(), e.runAction(cc.sequence(cc.spawn(cc.scaleTo(0.5, 1), cc.moveBy(0.5, 0, 200)), cc.fadeOut(0.5), cc.callFunc(function () {
    ...
    KnifeCollision: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../common/PlayerInfo'), i = e('./GameFunction'), r = e('../Common/PoolManager'), s = e('../Common/Utils'), l = e('./GameManager'), u = e('./InputController'), d = e('./MainGameUi'), p = e('./AudioManager'), f = cc._decorator, h = f.ccclass, m = f.property, g = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), t.prototype.start = function () {
                        ...
                        if ('bazi' == e.node.group) {
                            var n;
                            if (a.default.tuoweiCtrl = !1, a.default.playerTouch = !0, e.node.stopAllActions(), t.node.children[2].getComponent(cc.ParticleSystem).stopSystem(), i.default.Instance.ribbonEffect(t.node.position, e.node, !0), e.node.removeComponent(cc.PolygonCollider), t.node.stopAllActions(), a.default.knifeLR = t.node.x > 0 ? 1 : -1, t.node.children[1].scaleX = -a.default.knifeLR, this.great(t.node, e.node), i.default.Instance.CameraAoto(), i.default.Instance.CreateBazi(a.default.knifeLR), -1 == a.default.knifeLR)
                                (n = r.default.Spawn('arrowL', this.node.parent)).position = this.node.position, u.default.Instance.Arrow = n, n.active = !0, n.angle = -45, n.position = this.node.position, n.runAction(cc.repeatForever(cc.sequence(cc.rotateBy(0.8, -50), cc.rotateBy(1.6, 100), cc.rotateBy(0.8, -50)))), t.node.runAction(cc.sequence(cc.moveBy(0.05, -20, 0), cc.moveBy(0.05, 20, 0))), e.node.runAction(cc.sequence(cc.moveBy(0.05, -20, 0), cc.moveBy(0.05, 20, 0)));
                            else
                                (n = r.default.Spawn('arrowR', this.node.parent)).position = this.node.position, u.default.Instance.Arrow = n, n.active = !0, n.angle = 45, n.position = this.node.position, n.runAction(cc.repeatForever(cc.sequence(cc.rotateBy(0.8, -50), cc.rotateBy(1.6, 100), cc.rotateBy(0.8, -50)))), t.node.runAction(cc.sequence(cc.moveBy(0.05, 20, 0), cc.moveBy(0.05, -20, 0))), e.node.runAction(cc.sequence(cc.moveBy(0.05, 20, 0), cc.moveBy(0.05, -20, 0)));
                        ...
                        if (Math.abs(e.y - t.y) <= 15) {
                            ...
                            e.x > 0 ? n.position = cc.v2(e.x - 40, e.y) : n.position = cc.v2(e.x + 40, e.y), n.runAction(cc.sequence(cc.spawn(cc.moveBy(0.4, 0, 200), cc.rotateBy(0.4, 360)), cc.scaleTo(0.15, 1.1), cc.scaleTo(0.15, 1), cc.fadeOut(0.2))), a.default.score += 10, d.default.Instance.SetScoreTween(a.default.score);
                        } else
                            p.default.Instance.Play(0, !1, 1), a.default.score += 5, d.default.Instance.SetScoreTween(a.default.score);
                        ...
                        for (var n = s.default.RandomInteger(24, 36), o = 0; o < n; o++) {
                            ...
                            c.position = e, c.opacity = 0, c.scale = s.default.Random(0.5, 1), c.angle = s.default.Random(0, 360);
                            var a = cc.v2(0, 1);
                            ...
                            var l = s.default.Random(0.3, 0.5), u = s.default.Random(0.01, 0.012);
                            c.runAction(cc.sequence(cc.delayTime(u), cc.delayTime(0.6 * l), cc.scaleTo(0.4 * l, 0))), c.opacity = 0, c.runAction(cc.sequence(cc.delayTime(u), cc.fadeTo(0.1, s.default.Random(120, 240)))), c.runAction(cc.sequence(cc.delayTime(u), cc.moveBy(l, a.mul(i)).easing(cc.easeCubicActionOut()), cc.callFunc(function (e) {
                        ...
                        for (var n = 0; n < 10; n++) {
                            ...
                            o.scale = 0.1 * t, o.position = s.default.convetOtherNodeSpaceAR(e, cc.find('Canvas/upEffectParent')), 1 == t && (o.color = new cc.Color().fromHEX('ffc049'));
                            var c = new Array();
                            c.push(-360, 360), o.runAction(cc.sequence(cc.spawn(cc.jumpBy(0.5, s.default.RandomInteger(-100, 100), s.default.RandomInteger(-200, -100), s.default.RandomInteger(0, 50), 1), cc.rotateTo(0.5, s.default.RandomIndexFromArr(c)), cc.fadeOut(0.5)), cc.delayTime(0.1)));
                        }
                    }, t.prototype.createWord = function (e) {
                        var t = r.default.Spawn('star', cc.find('Canvas/upEffectParent'));
                        t.position = s.default.convetOtherNodeSpaceAR(this.node, cc.find('Canvas/upEffectParent')), 2 == e ? (t.scale = 0.3, t.opacity = 200, t.runAction(cc.sequence(cc.spawn(cc.rotateBy(0.2, 400), cc.moveBy(0.2, 0, 100)), cc.scaleTo(0.2, 0.5), cc.scaleTo(0.2, 0.4), cc.fadeOut(0.1)))) : (t.scale = 0.5, t.runAction(cc.sequence(cc.spawn(cc.rotateBy(0.2, 400), cc.moveBy(0.2, 0, 100)), cc.scaleTo(0.2, 0.6), cc.scaleTo(0.2, 0.5), cc.fadeOut(0.1))));
                        ...
                        var t = this.node.x + this.node.width / 2, n = this.node.x - this.node.width / 2, o = this.node.y;
                        ...
                        for (var n = 0; n < 3; n++)
                            setTimeout(function () {
                                var t = r.default.Spawn('star', cc.find('Canvas/upEffectParent'));
                                t.position = e.position, t.scale = 0.3, t.runAction(cc.sequence(cc.scaleTo(0.5, 1.1), cc.fadeOut(0.5)));
                            }, 300 * n);
                    }, t.prototype.addScoreEffect = function () {
                        var e = r.default.Spawn('add1', cc.find('Canvas/mainGameUi'));
                        e.position = cc.find('Canvas/mainGameUi').children[0].position.add(cc.v2(0, 50)), e.runAction(cc.spawn(cc.moveBy(0.5, 0, 50), cc.fadeOut(0.5)));
    ...
    MainGameJS: [
        function (e, t, n) {
            ...
            var o = e('GameConfig'), c = e('GameUiTools'), a = e('MainManage');
            cc.Class({
                ...
                addTouchEvents: function () {
                    ...
                    this.node.on(cc.Node.EventType.TOUCH_START, function (t) {
                        if (o.GAME_OVER_BOOL && o.noTouchBool)
                            return o.gameScore++, e.sceneScore.string = o.gameScore, console.log('ggoog', o.gameScore), o.gameScore >= 2 && (this.lastPos = t.getLocation(), e.gameEnd()), !0;
                ...
                gameEnd: function () {
                    o.GAME_OVER_BOOL = !1, a.gameOverShowText(o.gameScore, 1), this.node.runAction(cc.sequence(cc.delayTime(0.5), cc.callFunc(this.gameEnd1.bind(this))));
                },
                ...
                gameEnd1: function () {
                    var e = this, t = this.returnCurrentLanType();
                    1 == t ? (this.gameOverT1.string = '游 戏 结 束', this.gameOverT2.string = '点 击 查 看 分 数') : 2 == t ? (this.gameOverT1.string = '遊 戲 結 束', this.gameOverT2.string = '點 擊 查 看 分 數') : 4 == t ? (this.gameOverT1.string = '게임 종료', this.gameOverT2.string = '클릭 하여 점수 보기') : (this.gameOverT1.string = 'Game Over', this.gameOverT2.string = 'Click to view the score'), this.gameOveEndBool = !0, this.gameOverT1.node.zIndex = 999, this.gameOverT2.node.zIndex = 999, this.gameOverToEnd.zIndex = 999, this.gameOverT1.node.opacity = 0, this.gameOverT1.node.y = 100, this.gameOverToEnd.y = 0, this.gameOverT1.node.runAction(cc.sequence(cc.delayTime(0.2), cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)), cc.delayTime(0.3))), this.gameOverToEnd.runAction(cc.sequence(cc.fadeTo(1, 100), cc.callFunc(function () {
                        e.gameOverToEnd.getComponent(cc.Button).enabled = !0;
                    }))), this.gameOverT2.node.opacity = 0, this.gameOverT2.node.y = this.gameOverT1.node.y - 100, this.gameOverT2.node.runAction(cc.sequence(cc.delayTime(0.2), cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)), cc.delayTime(0.3))), this.gameOverT2.node.runAction(cc.sequence(cc.delayTime(2), cc.scaleTo(0.3, 1.2).easing(cc.easeSineInOut()), cc.scaleTo(0.3, 1).easing(cc.easeSineInOut()))).repeatForever();
                },
    ...
    MainGameUi: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../common/PlayerInfo'), i = e('./EffectCenter'), r = e('./AudioManager'), s = e('./DataManager'), l = e('../commonJs/GameConfig'), u = e('../common/DynamicLoad'), d = cc._decorator, p = d.ccclass, f = d.property, h = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.mainCamera = null, t.bgLayer = null, t.scoreLabel = null, t.scorePanel = null, t.guidePanel = null, t.injuredPanel = null, t.levelPanel = null, t.levelProgress = null, t.heartPanel = null, t.congratulation = null,t.player = null, t.basicsScore = 300, t.currentScore = 0, t.targetScore = 0, t.scoreChangeValue = 0, t.isScoreChange = !1, t.lerpCtrl = !1, t.relerpCtrl = !1, t.level = 1, t.nowYQ = 0, t.passlevelYQ = 1, t.congratulationTime = 0, t;
                    }
                    var n;
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        null != n.Instance && n.Instance.destroy(), n.Instance = this;
                        ...
                        var e = this;
                        this.ShowScorePanel(), s.default.Instance.GetLevel() % 5 == 1 ? (this.passlevelYQ = 0.12, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 2 ? (this.passlevelYQ = 0.31, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 3 ? (this.passlevelYQ = 0.51, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 4 ? (this.passlevelYQ = 0.71, this.lerpCtrl = !0) : s.default.Instance.GetLevel() % 5 == 0 && (this.passlevelYQ = 1, this.lerpCtrl = !0);
                    }, t.prototype.update = function (e) {
                        ...
                        this.levelPanel.children[1].children[0].getComponent(cc.Label).string = this.level.toString(), this.levelPanel.children[2].children[0].getComponent(cc.Label).string = (this.level + 1).toString(), this.levelPanel.children[1].runAction(cc.sequence(cc.scaleTo(0.2, 1.2), cc.scaleTo(0.2, 1))), this.levelPanel.children[2].runAction(cc.sequence(cc.scaleTo(0.2, 1.2), cc.scaleTo(0.2, 1))), this.levelPanel.children[0].children[0].getComponent(cc.Sprite).fillRange = 0, this.lerpCtrl = !1;
                    }, t.prototype.lerpNumFunc = function (e) {
                        var t = this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange;
                        e > t ? (this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange += 0.005, (t = this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange) >= e && (this.lerpCtrl = !1)) : (this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange -= 0.015, (t = this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange) == e && (this.lerpCtrl = !1));
                    }, t.prototype.lerpNumFunc1 = function () {
                        this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange -= 0.03, this.levelProgress.children[0].children[0].getComponent(cc.Sprite).fillRange <= 0 && (this.relerpCtrl = !1, this.showLevelProgressInfo());
                    }, t.prototype.GuideArrawAction = function () {
                        this.guidePanel.children[0].active = !0, this.guidePanel.children[0].runAction(cc.repeatForever(cc.sequence(cc.fadeIn(0.1), cc.moveTo(1, 240, 190), cc.moveTo(0.5, 120, 70), cc.fadeOut(0.5), cc.moveTo(0.01, -240, 190))));
                        ...
                        this.scoreLabel.node.children[1].x = 60 + 25 * t, e < 1000 ? (this.scoreLabel.string = String(e), this.scorePanel.children[0].children[0].active = !1, this.scorePanel.children[0].children[1].active = !0) : (this.scoreLabel.string = String(e), this.scoreLabel.node.scale = 0.7, this.scorePanel.children[0].children[0].active = !1, this.scorePanel.children[0].children[1].active = !0), a.default.score = e;
                    }, t.prototype.InjuredEffect = function () {
                        this.injuredPanel.active = !0, this.injuredPanel.runAction(cc.sequence(cc.fadeTo(0.1, 150), cc.fadeTo(0.1, 0)));
                    }, t.prototype.HideScorePanel = function () {
                        this.scorePanel.runAction(cc.moveBy(0.5, 0, 250)), this.levelPanel.runAction(cc.moveBy(0.5, 0, 250)), this.levelProgress.runAction(cc.moveBy(0.5, 0, 250)), this.heartPanel.runAction(cc.moveBy(0.5, 0, 250));
                    }, t.prototype.ShowScorePanel = function () {
                        var e = this.node.children[0].position;
                        this.scorePanel.runAction(cc.moveTo(0.5, cc.v2(this.scorePanel.x, e.y - 20)).easing(cc.easeBackOut())), this.levelPanel.runAction(cc.moveTo(0.5, e).easing(cc.easeBackOut())), this.levelProgress.runAction(cc.moveTo(0.5, cc.v2(-230, e.y - 50)).easing(cc.easeBackOut())), this.heartPanel.runAction(cc.moveTo(0.5, cc.v2(270, e.y - 50)).easing(cc.easeBackOut()));
                    }, t.prototype.showCongratulation = function () {
                        var e = this;
                        r.default.Instance.Play(1, !1, 1), a.default.GameUpdateCtrl = !1, this.congratulation.active = !0, this.player.getComponent(cc.PolygonCollider).enabled = !1, this.congratulation.children[1].children[2].getComponent(cc.Label).string = a.default.score.toString(), this.congratulation.children[1].runAction(cc.sequence(cc.scaleTo(0.5, 1).easing(cc.easeBackOut()), cc.callFunc(function () {
                            e.congratulation.children[2].active = !0;
                        })));
                    }, t.prototype.closeCongratulation = function () {
                        var e = this;
                        this.congratulation.children[2].active = !1, this.congratulation.children[1].runAction(cc.sequence(cc.scaleTo(0.5, 0).easing(cc.easeBackIn()), cc.callFunc(function () {
    ...
    MainManage: [
        function (e, t, n) {
            ...
            var o = e('HttpManagerJs'), c = e('LanguageSetJs'), a = e('GameConfig'), i = e('LoadSceneJs'), r = (e('GameUiTools'), {
                    gameHttpId: 0,
                    subScoreHttp: null,
                    gameNameText: null,
                    gameInfoText: null,
                    ...
                    init: function (e, t, n) {
                        ...
                        a.launchScene = e, a.Bros = t, a.caS = n, this.curType = 1;
                    ...
                    getHttpGameId: function () {
                        var e = window.location.href, t = e.substring(0, e.lastIndexOf('//') + 2), n = window.location.host, o = t + n + '/Service/Share/index';
                        ...
                        var c = document.URL, a = 0, i = c.substring(c.lastIndexOf('/game/') + 1, c.length).split('/');
                    ...
                    getLinkGameReturn: function (e, t, n, o) {
                        if (console.log('err0', e), console.log('err1', t), console.log('err2', n), console.log('err3', o), 0 == e) {
                            ...
                            var c = a.launchScene, r = a.Bros, s = a.caS;
                    ...
                    ranRecGameData: function () {
                        if (null != this.recGameData && '' != this.recGameData) {
                            this.returnBool = !1;
                            var e = this.recGameData.length, t = a.returnRanNum(1, e) - 1;
                    ...
                    ranLinkUrl: function () {
                        if (null != this.ranLinkData && this.ranLinkData.gameList && null != this.ranLinkData.gameList) {
                            var e = this.ranLinkData.gameList.length, t = a.returnRanNum(1, e) - 1;
    ...
    NewAttribute: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var c = cc._decorator, a = c.ccclass, i = c.property, r = function () {
                    function e() {
                        this.nickName = '大掌教', this.qGroup = '704391772';
                    }
                    return o([i({ displayName: '昵称' })], e.prototype, 'nickName', void 0), o([i({ displayName: 'Q群' })], e.prototype, 'qGroup', void 0), e = o([a('Player')], e);
                }();
    ...
    PlayerInfo: [
        function (e, t, n) {
            'use strict';
            cc._RF.push(t, 'ea489dPDU9OZYOr2dE1HqB7', 'PlayerInfo'), Object.defineProperty(n, '__esModule', { value: !0 });
            var o = function () {
                function e() {
                }
    ...
    RandomFly: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('./SpriteManager'), i = e('./Utils'), r = cc._decorator, s = r.ccclass, l = r.property, u = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), t.prototype.onLoad = function () {
                        ...
                        e < 1 && (e = 1), e > 4 && (e = 4);
                        var t = a.default.Instance.GetSpriteFrame('littleWing' + e), n = a.default.Instance.GetSpriteFrame('littleBody' + e);
                        ...
                        this.wing_r.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(0.2, 1).easing(cc.easeSineInOut()), cc.scaleTo(0.2, 0.4, 1).easing(cc.easeSineInOut())))), this.wing_l.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(0.2, -1, 1).easing(cc.easeSineInOut()), cc.scaleTo(0.2, -0.4, 1).easing(cc.easeSineInOut()))));
                    }, t.prototype.start = function () {
                        ...
                        var e = Math.random() * this.mosquitoTargetMaxR * (Math.abs(this.mosquitoSpeedR) / (this.mosquitoSpeedMaxR + 0.4 * this.mapScale));
                        ...
                        var e = this.mosquitoSpeedLen, t = this.mosquitoSpeedR, n = this.mosquitoTargetR, o = this.node, c = this.getPointByCPAndAngleAndLen(o.getPosition(), o.angle + t, e);
                        ...
                        this.isUpdate && this.isUser && (this.updateMosquito(), this.checkOnEdge(!0)), this.isFade || (this.fadeTicker -= e, this.fadeTicker < 0 && (this.fadeTicker = 0, this.isFade = !0, this.node.runAction(cc.sequence(cc.fadeOut(0.5), cc.callFunc(function (e) {
                        }, this)))));
                    }, t.prototype.updateMove_1 = function (e) {
                        this.dir = cc.v2(this.node.position).sub(this.newPos).normalize().neg();
                        var t = 1 * (this.dir.x * this.mosquitoSpeedLen * 3), n = 1 * (this.dir.y * this.mosquitoSpeedLen * 3), o = this.node.x + t, c = this.node.y + n;
                        ...
                        this.dir = cc.v2(this.node.position).sub(this.newPos).normalize().neg();
                        var t = 1 * (this.dir.x * this.mosquitoSpeedLen), n = 1 * (this.dir.y * this.mosquitoSpeedLen), o = this.node.x + t, c = this.node.y + n;
                        this.node.x = o, this.node.y = c;
                        var a = 180 * Math.atan2(this.dir.y, this.dir.x) / Math.PI;
                        a = 360 - a + 90, this.node.angle = a;
                        ...
                        var c = Math.abs(e - n), a = Math.abs(t - o), i = a / Math.sqrt(Math.pow(c, 2) + Math.pow(a, 2)), r = Math.acos(i), s = 180 / (Math.PI / r);
                        return t > o && (s = 180 - s), e > n && (s *= -1), s;
                    }, t.prototype.getPointByCPAndAngleAndLen = function (e, t, n) {
                        var o = -t * Math.PI / 180, c = n * Math.cos(o), a = n * Math.sin(o);
            ...
            var a = cc._decorator, i = a.ccclass, r = a.property, s = function (e) {
                    ...
                    return o(t, e), t.prototype.start = function () {
                        ...
                        for (var e = 0; e < 50; e++) {
                            ...
                            t || (t = cc.instantiate(this.prefab_water), this.waterParent.addChild(t)), t.active = !1, t.scale = 0.4, t.x = this.cup.x, t.y = this.cup.y + 10;
                        }
                        this._waterGenrateCount = 0, this.schedule(this.scheduleWater, 0.05, this.waterParent.childrenCount - 1);
    ...
    RotateAround: [
        function (e, t, n) {
            ...
            var i = cc._decorator, r = i.ccclass, s = i.property, l = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return c(t, e), t.prototype.start = function () {
                        ...
                        if (this.isRotating && this.targetPos) {
                            ...
                            if (this.node.x = this.targetPos.x + this.radius * Math.cos(t), this.node.y = this.targetPos.y + this.radius * Math.sin(t), this.faceToTarget)
                        ...
                        if (e && (this.targetPos = e), t && (this.clockwise = t), n && (this.timePerRound = n), o && (this.faceToTarget = o), c && (this.faceAxis = c), !this.targetPos)
                    ...
                    }, a([s(cc.Vec2)], t.prototype, 'targetPos', void 0), a([s({ tooltip: !1 })], t.prototype, 'clockwise', void 0), a([s({ tooltip: !1 })], t.prototype, 'timePerRound', void 0), a([s({ tooltip: !1 })], t.prototype, 'faceToTarget', void 0), a([s({
                            type: cc.Enum(o),
                            tooltip: !1,
                            visible: function () {
                                return this.faceToTarget;
                            }
                        })], t.prototype, 'faceAxis', void 0), a([s({ tooltip: '自动开始旋转' })], t.prototype, 'autoStart', void 0), t = a([r], t);
                }(cc.Component);
            n.default = l, cc._RF.pop();
        },
        {}
    ...
    Shake: [
        function (e, t, n) {
            ...
            var o = cc.ActionInterval.extend({
                ...
                update: function (e) {
                    var t = this.getRandomStrength(-this.nodeShakeStrengthX, this.nodeShakeStrengthX) * cc.director.getDeltaTime(), n = this.getRandomStrength(-this.nodeShakeStrengthY, this.nodeShakeStrengthY) * cc.director.getDeltaTime();
    ...
    Stack: [
        function (e, t, n) {
            'use strict';
            cc._RF.push(t, '17b226CrNJGGYSBKYckUg+j', 'Stack'), Object.defineProperty(n, '__esModule', { value: !0 });
            var o = function () {
                function e(e) {
        ...
        function (e, t, n) {
            ...
            var o = function () {
                function e() {
                    ...
                    t.isAlignBottom = !0, t.isAbsoluteBottom = !1, t.bottom = 0.8, t.isAlignHorizontalCenter = !0, t.horizontalCenter = 0, t.alignMode = cc.Widget.AlignMode.ONCE;
                ...
                return Object.defineProperty(e, 'instance', {
                    ...
                    var n = this;
                    void 0 === t && (t = 0.5), e.length * this.textLabel.fontSize > 0.8 * this.canvas.node.width && (this.textLabel.overflow = cc.Label.Overflow.RESIZE_HEIGHT, this.textLabel.node.width = 0.8 * this.canvas.node.width), this.textLabel.string = e, this.toastNode.active = !0, this.toastNode.opacity = 200, this.toastNode.runAction(cc.sequence(cc.delayTime(t), cc.fadeOut(0.2), cc.callFunc(function () {
        ...
        function (e, t, n) {
            ...
            var o = {
                ...
                writeJson: function (e, t) {
                    if (cc.sys.isBrowser) {
                        console.log('浏览器');
                        var n = new Blob([e], { type: 'application/json' }), o = document.createElement('a');
                ...
                clonePrefabs: function (e, t, n) {
                    var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, c = this.PrefabArrJs.getPrefabs(e);
                    if (null != c) {
                ...
                newLabel: function (e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 20, o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0.5, c = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0.5, a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, i = new cc.Node();
                    i.anchorX = o, i.anchorY = c;
                    var r = i.addComponent(cc.Label);
                    return r.string = e, r.fontSize = n, t.addChild(i, a), i;
                },
                playAudio: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0.5, n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
    ...
    Utils: [
        function (e, t, n) {
            'use strict';
            cc._RF.push(t, 'f3369tYECpPVJGWDo7sIHaO', 'Utils'), Object.defineProperty(n, '__esModule', { value: !0 });
            var o = function () {
                function e() {
                }
                return e.getBezierPos = function (e, t) {
                    var n = new Array(), o = e.length;
                    if (o < 2)
                        return cc.log('控制点数不能小于 2'), n;
                    for (var c = this.getYangHuiTriangle(o), a = 0; a < t; a++) {
                        for (var i = a / t, r = 0, s = 0, l = 0; l < o; l++)
                            r += Math.pow(1 - i, o - l - 1) * e[l].x * Math.pow(i, l) * c[l], s += Math.pow(1 - i, o - l - 1) * e[l].y * Math.pow(i, l) * c[l];
                        n[a] = new cc.Vec2(r, s);
                    }
                    return n;
                    ...
                    for (c = 0; c < t.length; c++)
                        0 != c && (a += e), t[c].x = a + 0.5 * t[c].width, a += t[c].width;
                }, e.CheckPolygonNodeCollision = function (t, n) {
                    var o = t.getComponent(cc.PolygonCollider), c = n.getComponent(cc.PolygonCollider);
                    if (null == o || null == c)
                        return !1;
                    ...
                    var i = Math.floor(100 * Math.random()), r = -1;
                    for (c = 0; c < t.length; c++) {
                    ...
                    for (var n = 0; n < t.length; n++) {
                        var o = e.RandomInteger(0, t.length), c = t[o];
                        t[o] = t[n], t[n] = c;
                    }
                    return t;
                    ...
                    var i = n + (e.x - t.x / 2 + 0.5) * c, r = o + (e.y + 0.5) * a;
                    return cc.v2(i, r);
                }, e.worldPosToCbPos = function (e, t, n, o, c, a) {
                    var i = (e.x - n) / c - 0.5 + t / 2, r = (e.y - o) / a - 0.5;
                    ...
                    if (Math.abs(e.x) + Math.abs(e.y) !== 0) {
                        var t = cc.v2(0, 1), n = cc.v2(e).signAngle(t);
                    ...
                    var n = e.x - t.x, o = e.y - t.y, c = cc.v2(n, o);
        ...
        function (e, t, n) {
            ...
            cc._RF.push(t, '813eeXgvcJG96hqXhg+nvJ0', 'bfPrefabJs'), cc.Class({
                ...
                updateMosquito: function () {
                    var e = this.mosquitoSpeedLen, t = this.mosquitoSpeedR, n = this.mosquitoTargetR, c = this.node, a = o.getPointByCPAndAngleAndLen(c.getPosition(), c.angle + t, e);
    ...
    fruitData: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../common/PlayerInfo'), i = e('./GameFunction'), r = e('../Common/PoolManager'), s = e('../Common/Utils'), l = e('../common/DynamicLoad'), u = e('./MainGameUi'), d = e('./AudioManager'), p = cc._decorator, f = p.ccclass, h = p.property, m = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), t.prototype.onLoad = function () {
                        ...
                        if (this.node.x < -this.bianjieX && (this.node.x = -this.bianjieX), this.node.x > this.bianjieX && (this.node.x = this.bianjieX), this.notTargetTime += e, this.returnNumber && (this.scheduleOnce(function () {
                                t.getNumberTime = 0;
                            }, 0.25), this.returnNumber = !1), 'fruitNode' == this.node.parent.name && (this.testEndDJS += e), this.node.y + this.node.width / 2 > cc.find('Canvas/lineNode').children[0].y && 0 == this.pengzhuangCount && this.endCtrl && 0 == this.endOne && this.testEndDJS > 3) {
                            a.default.GameUpdateCtrl = !1, a.default.playerTouch = !1;
                            for (var n = 0; n < cc.find('Canvas/fruitNode').children.length; n++)
                                cc.find('Canvas/fruitNode').children[n].removeComponent(cc.PhysicsCircleCollider), cc.find('Canvas/fruitNode').children[n].removeComponent(cc.RigidBody);
                            this.node.color = cc.Color.RED, cc.tween(this.node).to(0.3, { opacity: 0 }).to(0.3, { opacity: 255 }).union().repeat(3).call(function () {
                        ...
                        if ('downwall' == n.node.group && (t.node.parent = cc.find('Canvas/fruitNode'), 0 == this.wallColl && (d.default.Instance.Play(5, !1, 1), this.wallColl++)), 'fruit' == n.node.group) {
                            if (this.endCtrl = !0, t.node.y < n.node.y)
                                return;
                            ...
                            var c = this.fruitNumber, r = n.node.getComponent('fruitData').fruitNumber;
                            c == r && c < 9 && r < 9 ? (this.pengzhuangCount += 1, 0 == t.node.getComponent('fruitData').getNumber() && (a.default.score += this.fruitNumber + 1, u.default.Instance.SetScoreTween(a.default.score), n.node.getComponent(cc.PhysicsCircleCollider).radius = 0, n.node.getComponent(cc.PhysicsCircleCollider).apply(), this.node.getComponent(cc.PhysicsCircleCollider).radius = 0, this.node.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(t.node).to(0.1, { position: n.node.position }).call(function () {
                                ...
                                var r = new cc.Node();
                                r.addComponent(cc.Sprite).spriteFrame = l.default.Instance.caidia[6], r.scale = 3, r.parent = c, r.position = cc.v2(0), cc.tween(r).by(5, { angle: 360 }).repeatForever().start();
                                var s = new cc.Node();
                        ...
                        e.position = this.node.position, e.runAction(cc.sequence(cc.delayTime(0.5), cc.fadeOut(0.5)));
                    }, t.prototype.createStar = function () {
                        var e = r.default.Spawn('star', cc.find('Canvas/upEffectParent'));
                        e.scale = s.default.Random(0.1, 1);
                        var t = this.node.x + this.node.width / 2, n = this.node.x - this.node.width / 2, o = this.node.y;
    ...
    gameOverJs: [
        function (e, t, n) {
            ...
            var o = e('GameUiTools'), c = e('GameConfig'), a = e('MainManage');
            cc.Class({
                extends: cc.Component,
                properties: {
                    bgLayer: cc.Node,
                ...
                onLoad: function () {
                    ...
                    var n = c.gameScore, o = this.getHighScore();
                ...
                UIPosChange: function () {
                    ...
                    if (this.overInfoT.node.height = Math.ceil(e.length * this.overInfoT.fontSize / this.overInfoT.node.width) * t, document.title = e, console.log('gameOver txtMoreText', a.txtMoreText), this.midGameText.string = a.txtMoreText, this.leftBtnText.string = a.txtAgainText, this.tempArr = this.gameFocus(), null != a.ranLinkUrl()) {
                        var n = a.ranLinkUrl(), o = a.ranLinkData.gameList[n].gameName;
                ...
                gameFocus: function () {
                    var e = [], t = null, n = null;
                    return Math.random() <= 0.5 ? (t = a.gameEndName1, n = a.gameEndUrl1) : (t = a.gameEndName2, n = a.gameEndUrl2), e.push(t), e.push(n), e;
                },
                ...
                getContentByScore: function (e, t) {
                    var n = '我真是太厉害\uFF0C在' + t + '中竟然得了1分\uFF0C全球只有1个人得1分\uFF01', o = parseInt(0.3 * this.standardScore), c = parseInt(1.5 * this.standardScore), a = parseInt(2.5 * this.standardScore), i = parseInt(4 * this.standardScore);
                    if (e > 0 && e <= o)
                ...
                getContentByScore2: function (e, t) {
                    var n = 'I\'m awesome\uFF0Cin' + t + 'get 0 score\uFF0Conly one person in the world has a 0\uFF01', o = parseInt(0.3 * this.standardScore), c = parseInt(1.5 * this.standardScore), a = parseInt(2.5 * this.standardScore), i = parseInt(4 * this.standardScore);
    ...
    linkHttpIconJs: [
        function (e, t, n) {
            ...
            var o = e('MainManage'), c = e('GameConfig');
            cc.Class({
                extends: cc.Component,
                properties: {
                    iconSpr: cc.Node,
                ...
                onLoad: function () {
                    if (this._imageArr = [], this.stopUpdateBool = !0, this.gameWidth = cc.winSize.width, this.gameHeight = cc.winSize.height, null != o.recGameData && '' != o.recGameData && null != o.recGameimg1 && '' != o.recGameimg1) {
                        ...
                        var n = o.recGameimg1, c = o.recGameimg2, a = this.iconSpr, i = this.iconSpr1, r = this;
                ...
                showLinkPic: function () {
                    var e = 0, t = 0;
                    e = null != o.recGameDelPau ? o.recGameDelPau : 6, cc.log('dMainManager.recGameDelPer', o.recGameDelPer), t = null != o.recGameDelPer ? o.recGameDelPer : 0.7, this._imageArr[0].opacity = 255, this._imageArr[0].runAction(cc.repeatForever(cc.sequence(cc.delayTime(e), cc.rotateBy(t, 0, 180), cc.callFunc(function () {
                    ...
                    var e = this, t = {
                            ...
                            onTouchBegan: function (t, n) {
                                ...
                                if (e._imageArr.length >= 2) {
                                    var i = Math.abs(a.x - e.gameWidth / 2 - e._imageArr[0].x), r = Math.abs(a.y - e.gameHeight / 2 - e._imageArr[0].y);
                                    i <= 30 && r <= 30 && (c.noTouchBool = !1, null != o.recGameUrl && '' != o.recGameUrl && (e._imageArr[0].runAction(cc.sequence(cc.scaleTo(0.1, 0.8), cc.scaleTo(0.1, 1), cc.callFunc(function () {
                                        window.location.href = o.recGameUrl;
                                    }))), e._imageArr[1].runAction(cc.sequence(cc.scaleTo(0.1, 0.8), cc.scaleTo(0.1, 1)))), console.log('touchLinkHttp'));
                                }
                                return !0;
                            },
    ...
    peaCannonAI: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../Common/Utils'), i = e('../common/PlayerInfo'), r = e('../Common/PoolManager'), s = e('./GameFunction'), l = e('./MainGameUi'), u = e('./AudioManager'), d = cc._decorator, p = d.ccclass, f = d.property, h = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.shellNode = null, t.player = null, t.shootInter = 2, t.shootTime = 0, t.cannonNumber = 0, t.peaSuiPre = null, t;
                    }
                    return o(t, e), t.prototype.start = function () {
                        this.shellNode = cc.find('Canvas/shellNode'), this.player = cc.find('Canvas/playerNode/player'), this.node.scale = 0.7;
                    }, t.prototype.update = function (e) {
                        if (i.default.GameUpdateCtrl) {
                            var t = this.player.position.sub(this.node.position).normalize(), n = a.default.vectorsToDegress(t);
                        ...
                        this.node.runAction(cc.sequence(cc.scaleTo(0.1, 0.7, 0.5), cc.scaleTo(0.1, 0.7, 0.7)));
                        var e = r.default.Spawn('shell', this.shellNode);
                        e.getComponent('shellData').shellLife = 2, e.position = this.node.position, e.opacity = 255, e.scale = 0.1, e.active = !0, u.default.Instance.Play(0, !1, 1);
                        var t = this.player.position.sub(e.position).normalize();
                        e.runAction(cc.scaleTo(0.2, 0.5)), e.runAction(cc.sequence(cc.moveBy(10, 2000 * t.x, 2000 * t.y), cc.callFunc(function () {
                        ...
                        for (var n = 0; n < t.children.length; n++)
                            t.children[n].runAction(cc.sequence(cc.spawn(cc.moveBy(0.25, a.default.RandomInteger(-70, 70), a.default.RandomInteger(-70, 70)), cc.rotateBy(0.5, a.default.RandomInteger(-360, 360))), cc.fadeOut(1), cc.callFunc(function () {
                                t.destroy();
                            })));
    ...
    resArr: [
        function (e, t, n) {
            ...
            cc._RF.push(t, '8a68e/WQz1Feo++msjg6z8R', 'resArr'), cc.Class({
                ...
                playAudio: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0.3, n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
    ...
    startGameJs: [
        function (e, t, n) {
            ...
            var o = e('GameUiTools'), c = (e('HttpManagerJs'), e('MainManage')), a = (e('LoadSceneJs'), e('GameConfig'));
            cc.Class({
                extends: cc.Component,
                properties: {
                    showInfoT: cc.Label,
    ...
    startPanel: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../Common/Utils'), i = e('../commonJs/GameConfig'), r = cc._decorator, s = r.ccclass, l = r.property, u = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), t.prototype.onLoad = function () {
                        ...
                        this.startPanel.children[1].scaleX = 0, this.startPanel.children[1].runAction(cc.scaleTo(0.5, 0.9).easing(cc.easeBackOut())), this.startPanel.children[2].runAction(cc.repeatForever(cc.sequence(cc.scaleTo(0.5, 1.1), cc.scaleTo(0.5, 1), cc.delayTime(0.5)))), this.initTitle(), cc.director.preloadScene('MainGameScene');
                    }, t.prototype.StartGame = function () {
                        i.publicGameBool || adBreak({
                            type: 'next',
                            name: 'restart-game'
                        }), this.startBtn.stopAllActions(), this.startBtn.runAction(cc.sequence(cc.scaleTo(0.1, 0.8), cc.scaleTo(0.1, 1), cc.callFunc(function () {
                        ...
                        for (var e = 0; e < this.titleSpr.children.length; e++) {
                            var t = this.titleSpr.children[e], n = Math.random() >= 0.5 ? 8 : -8, o = 0.8 + 0.3 * Math.random();
    ...
    wineObsmove: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('./GameFunction'), i = cc._decorator, r = i.ccclass, s = (i.property, function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.isMove = !1, t;
                    }
    ...
    winerCollision: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, '__esModule', { value: !0 });
            var a = e('../common/PlayerInfo'), i = e('../Common/PoolManager'), r = e('../Common/Utils'), s = e('./AudioManager'), l = e('./GameFunction'), u = e('./GameManager'), d = cc._decorator, p = d.ccclass, f = d.property, h = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return o(t, e), t.prototype.onLoad = function () {
                        ...
                        for (var n = 0; n < t.children.length; n++)
                            t.children[n].runAction(cc.spawn(cc.sequence(cc.jumpBy(1, r.default.RandomInteger(-500, 50), r.default.RandomInteger(-2000, -1600), 500, 1), cc.fadeOut(0.5)), cc.rotateBy(1, r.default.RandomInteger(-860, 860))));
                    }, t.prototype.createWineSa = function (e) {
                        for (var t = r.default.RandomInteger(35, 40), n = 0; n < t / 2; n++) {
                            (o = i.default.Spawn('juicePre', cc.find('Canvas/upEffectParent'))).color = new cc.Color().fromHEX(this.wineColorStr1[this.wineType - 1]), o.position = e.position, o.scale = 0.5, o.runAction(cc.spawn(cc.jumpBy(1, r.default.RandomInteger(-300, 50), r.default.RandomInteger(-400, -200), r.default.RandomInteger(100, 150), 1), cc.fadeOut(1)));
                        }
                        for (n = 0; n < t / 2; n++) {
                            var o;
                            (o = i.default.Spawn('juicePre', cc.find('Canvas/upEffectParent'))).color = new cc.Color().fromHEX(this.wineColorStr2[this.wineType - 1]), o.position = e.position, o.scale = 0.5, o.runAction(cc.spawn(cc.jumpBy(1, r.default.RandomInteger(-300, 50), r.default.RandomInteger(-400, -200), r.default.RandomInteger(100, 150), 1), cc.fadeOut(1)));
                        }
